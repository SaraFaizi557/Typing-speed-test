const Blur = ({ setIsBlur }) => {
  return (
    <div className="absolute gap-3 sm:gap-4 flex flex-col items-center left-0 pt-[25vh] lg:pt-[22vh] w-full backdrop-blur-sm h-full lg:h-[81vh] sm:h-[78vh] top-50 sm:top-60 lg:top-50 bottom-0 bg-[--Neutral-800]">
      <button
        onClick={() => {
          setIsBlur(false);
        }}
